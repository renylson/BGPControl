  ...
  return (
    <Box sx={{ minHeight: '100vh', p: 0, m: 0, background: 'linear-gradient(135deg, #181c24 0%, #232a36 100%)' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 200, m: 0 }}>
        <Box sx={{ width: '100%', maxWidth: 1000, mx: 'auto', mt: 0, mb: 0 }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, justifyContent: 'center', m: 0 }}>
            {/* Todos os itens em uma linha */}
            <Paper elevation={10} sx={{ p: 2, borderRadius: 3, background: 'linear-gradient(135deg, #1976d2 0%, #42a5f5 100%)', textAlign: 'center', boxShadow: '0 4px 16px 0 rgba(31,38,135,0.12)', minWidth: 120, width: { xs: 'calc(50% - 8px)', md: 'calc(20% - 8px)' }, flex: { md: '1' } }}>
            ...
            <Paper elevation={10} sx={{ p: 2, borderRadius: 3, background: 'linear-gradient(135deg, #9c27b0 0%, #ce93d8 100%)', textAlign: 'center', boxShadow: '0 4px 16px 0 rgba(31,38,135,0.12)', minWidth: 120, width: { xs: 'calc(50% - 8px)', md: 'calc(20% - 8px)' }, flex: { md: '1' } }}>
            ...
            <Paper elevation={10} sx={{ p: 2, borderRadius: 3, background: 'linear-gradient(135deg, #263238 0%, #90a4ae 100%)', textAlign: 'center', boxShadow: '0 4px 16px 0 rgba(31,38,135,0.12)', minWidth: 120, width: { xs: 'calc(50% - 8px)', md: 'calc(20% - 8px)' }, flex: { md: '1' } }}>
            ...
            <Paper elevation={10} sx={{ p: 2, borderRadius: 3, background: 'linear-gradient(135deg, #43a047 0%, #a5d6a7 100%)', textAlign: 'center', boxShadow: '0 4px 16px 0 rgba(31,38,135,0.12)', minWidth: 120, width: { xs: 'calc(50% - 8px)', md: 'calc(20% - 8px)' }, flex: { md: '1' } }}>
            ...
            <Paper elevation={10} sx={{ p: 2, borderRadius: 3, background: 'linear-gradient(135deg, #0288d1 0%, #b3e5fc 100%)', textAlign: 'center', boxShadow: '0 4px 16px 0 rgba(31,38,135,0.12)', minWidth: 120, width: { xs: 'calc(50% - 8px)', md: 'calc(20% - 8px)' }, flex: { md: '1' } }}>
